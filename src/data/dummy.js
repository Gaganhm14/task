...
import { BsBoxSeam, BsCurrencyDollar, BsShield, BsGearFill, BsCalendarEventFill, BsFillTagsFill } from 'react-icons/bs';
...
export const ecomPieChartData = [
  { x: 'Basic Trees', y: 55, text: '55%' },
  { x: 'CustombbShort Pants', y: 31, text: '31%' },
  { x: 'Super Hoodies', y: 14, text: '14%' },
];
